...
const (
	...
	EventServiceName = "gpgsmith.v1.EventService"
)
...
const (
	...
	EventServiceSubscribeProcedure = "/gpgsmith.v1.EventService/Subscribe"
)
...
// NewEventServiceClient constructs a client for the gpgsmith.v1.EventService service. By default,
...
func NewEventServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) EventServiceClient {
	...
	eventServiceMethods := v1.File_gpgsmith_v1_event_proto.Services().ByName("EventService").Methods()
...
// Subscribe calls gpgsmith.v1.EventService.Subscribe.
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/gpgsmith.v1.EventService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedEventServiceHandler) Subscribe(context.Context, *connect.Request[v1.SubscribeRequest], *connect.ServerStream[v1.Event]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("gpgsmith.v1.EventService.Subscribe is not implemented"))
}
